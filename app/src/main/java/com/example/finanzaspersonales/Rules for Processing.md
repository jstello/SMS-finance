...
2. Date Display:
   - List view: HH:mm format
   - Detail view: dd/MM/yy format
   - Transaction view: dd/MM/yyyy format
...
1. Data retention:
   - Maintain original SMS body indefinitely
   - Preserve original transaction dates
   - Never modify source data - only add annotations

2. Filtering:
   - Year/month filters apply to transaction dates
   - Search includes message body and contact names
...
2. Data protection:
   - Never store full message bodies externally
   - Anonymize data in backups
   - Encrypt shared preferences containing financial data